      ...
      <div class="wrapper">
         ...
         <div class="slider-area">
            <div class="slider-active owl-carousel">
               <div class="single-slider slider-2 bg-img" style="background-image: url(images/1.jpg)">
                  <div class="container">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="slider-content-2 slider-animated-1 mt-150">
                              <h5 class="animated">handmade products </h5>
                              <h2 class="animated">New <br>Collection 2018 </h2>
                              <a class="btn-style-2 cr-btn animated" href=""><span>View Products</span></a>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="slider-single-img-2 slider-animated-1">
                              <img class="animated" src="images/2_2.png" alt="slider images">
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="slider-single-img-2 slider-animated-2">
                              <img class="animated" src="images/5_1.png" alt="slider images">
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-6">
                     <div class="banner-wrapper mb-30">
                        <div class="banner-img overflow">
                           <a href="product-details.html"><img alt="" src="images/3_1.png"></a>
                  ...
                  <div class="col-lg-6">
                     <div class="banner-wrapper mb-30">
                        <div class="banner-img overflow">
                           <a href="product-details.html"><img alt="" src="images/4_1.png"></a>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="banner-wrapper overflow mb-30">
                        ...
                        <div class="banner-content-7">
                           <img alt="image" src="images/2_1.png">
                           <h2>Lovely Gift</h2>
                  ...
                  <div class="col-lg-6">
                     <div class="banner-wrapper overflow mb-30">
                        <div class="banner-img">
                           <a href="product-details.html">
                           <img alt="image" src="images/10.jpg">
                           </a>
                        </div>
                        <div class="banner-content-7">
                           <img alt="image" src="images/2_1.png">
            ...
            <div class="container-fluid">
               <div class="testimonial-active owl-carousel pt-130 pb-125 theme-bg">
                  <div class="single-testimonial text-center">
                     ...
                     <p>
                        I ordered a handmade craft piece for my home décor and I was amazed by the quality. 
                        The design is unique and you can clearly see the effort and creativity behind it. 
                        It truly adds a warm and artistic touch to my living space.
                     </p>
                  ...
                  <div class="single-testimonial text-center">
                     <img alt="" src="images/1.png">
                     <p>
                        Beautiful handmade products with great attention to detail. I bought one as a gift 
                        for my friend and she absolutely loved it. It feels special knowing that each craft 
                        item is carefully made by hand.
                     </p>
                     <div class="testimonial-icon">
                        <i class="ti-direction-alt"></i>
                     </div>
                  ...
                  <div class="single-testimonial text-center">
                     <img alt="" src="images/1.png">
                     <p>
                        These handcrafted pieces are simply wonderful. The finishing, colors, and overall 
                        design make them stand out from regular store products. I will definitely purchase 
                        more in the future.
                     </p>
                     <div class="testimonial-icon">
                        <i class="ti-direction-alt"></i>
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-6 col-12">
                     <div class="blog-hm-wrapper mb-40">
                        <div class="blog-img">
                           <a href="blog-details-standerd.html"><img src="images/1_2.jpg" alt="image"></a>
                        </div>
                        <div class="blog-hm-content">
                           <h3>
                              <a href="blog-details-standerd.html">
                              The Art of Handmade Crafts: Turning Creativity into Beautiful Pieces
                              </a>
                           </h3>
                           <div class="blog-meta">
                              <ul>
                                 <li><span>by:</span><a href="#">Admin</a></li>
                                 <li><span>On</span> 14 Oct, 2024</li>
                              </ul>
                           </div>
                           <p>
                              Handmade crafts bring creativity and uniqueness into everyday life. 
                              Each piece is carefully designed and crafted by hand, making it special 
                              and different from mass-produced items.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-12">
                     <div class="blog-hm-wrapper mb-40">
                        <div class="blog-img">
                           <a href="blog-details-standerd.html"><img src="images/2_1.jpg" alt="image"></a>
                        </div>
                        <div class="blog-hm-content">
                           <h3>
                              <a href="blog-details-standerd.html">
                              Why Handmade Crafts Make Perfect Gifts for Every Occasion
                              </a>
                           </h3>
                           <div class="blog-meta">
                              <ul>
                                 <li><span>by:</span><a href="#">Admin</a></li>
                                 <li><span>On</span> 10 Oct, 2024</li>
                              </ul>
                           </div>
                           <p>
                              Handmade gifts are meaningful and memorable. Whether it's a birthday, 
                              anniversary, or special celebration, handcrafted items add a personal 
                              and heartfelt touch to every occasion.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-12">
                     <div class="blog-hm-wrapper mb-40">
                        <div class="blog-img">
                           <a href="blog-details-standerd.html"><img src="images/3_1.jpg" alt="image"></a>
                        </div>
                        <div class="blog-hm-content">
                           <h3>
                              <a href="blog-details-standerd.html">
                              From Idea to Creation: The Handmade Craft Process
                              </a>
                           </h3>
                           <div class="blog-meta">
                              <ul>
                                 <li><span>by:</span><a href="#">Admin</a></li>
                                 <li><span>On</span> 05 Oct, 2024</li>
                              </ul>
                           </div>
                           <p>
                              Every handmade craft begins with an idea. Through patience, creativity, 
                              and skilled craftsmanship, that idea transforms into a beautiful and 
                              unique product loved by customers.
                           </p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 col-12">
                        <div class="footer-payment-method">
                           <a href="#"><img alt="" src="images/7.png"></a>
                        </div>
                     </div>
                  </div>
               </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/69b2a73235b1381c3be16852/1jjgtq7g1';
s1.charset='UTF-8';
